...
<header class="bg-blue-600 text-white shadow-md">
    <div class="container mx-auto p-4 flex justify-between items-center">
        ...
        <nav class="space-x-4">
            ...
            <a href="student.jsp" class="hover:underline">Student Dashboard</a>
        </nav>
    </div>
</header>
<main class="container mx-auto p-6 text-center">
    <div class="bg-white p-8 rounded-lg shadow-lg mt-8">
        ...
        <p class="text-lg text-gray-600">Access your exams, manage your profile, and view results. Log in or register to get started.</p>
    </div>
</main>
</body>
</html>